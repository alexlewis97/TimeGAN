...
def predictive_score_metrics (ori_data, generated_data):
  ...
  # Input place holders
  X = tf.compat.v1.placeholder(tf.compat.v1.float32, [None, max_seq_len-1, dim-1], name = "myinput_x")
  T = tf.compat.v1.placeholder(tf.compat.v1.int32, [None], name = "myinput_t")    
  Y = tf.compat.v1.placeholder(tf.compat.v1.float32, [None, max_seq_len-1, 1], name = "myinput_y")
